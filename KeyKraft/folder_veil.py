...
def seticon(folderpath, iconpath, iconindex):
    ...
    folderpath = open(os.path.abspath(folderpath), 'r')
    iconpath = open(os.path.abspath(iconpath), 'r')
...
seticon(r'C:\Users\User\Desktop\MISSING', r'C:\Windows\system32\SHELL32.dll', 10)